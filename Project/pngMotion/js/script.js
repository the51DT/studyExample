...
ani2_png1.to($('#sectionTwo .flower'), 1, {opacity: 1, delay: 1.2, marginTop: 0, animationName: 'pngAni1'})
...
ani2_png2.to($('#sectionTwo .sunglass'), 1, {opacity: 1, delay: 1, marginTop: 0, animationName: 'pngAni2'})
var scene = new ScrollMagic.Scene({
  triggerElement: '#sectionTwo',
  triggerHook: 0.2
})
